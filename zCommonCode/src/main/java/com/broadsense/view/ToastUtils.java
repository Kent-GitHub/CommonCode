...
//    };
    ...
    public static void showShortToast(Context context, String message) {
        showShortToastOffset(context, message, 0);
    }

    public static void showShortToastOffset(Context context, String message, int offset) {
...
//        mHandler.removeCallbacks(r);
        if (mToast == null) {//只有mToast==null时才重新创建，否则只需更改提示文字
            ...
            mToast.setGravity(Gravity.BOTTOM, offset, 60);
            mToast.setView(view);
        } else {
            mToast.setDuration(Toast.LENGTH_SHORT);
            mToast.setGravity(Gravity.BOTTOM, offset, 60);
